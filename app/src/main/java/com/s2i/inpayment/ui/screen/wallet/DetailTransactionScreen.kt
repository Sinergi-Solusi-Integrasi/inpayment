...
@OptIn(ExperimentalMaterialApi::class, ExperimentalPermissionsApi::class, ExperimentalMaterial3Api::class)
@Composable
                            ...
                            onClick = {
                                ...
                                when (label) {
                                    "Share" -> coroutineScope.launch {
                                        excludeImage = true
                                        delay(300)
                                        transactionView.value?.let { composeView ->
                                            val bitmap = captureView(composeView) { excludeImage = it }
